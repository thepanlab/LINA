...
class MLP(nn.Module):
    def __init__(
        ...
        self.interaction_mlp = create_mlp([num_features] + hidden_units + [1],bn)
    ...
    def create_main_effect_nets(self, num_features, hidden_units, out_bias, name,bn=False):
        mlp_list = [
            create_mlp([1] + hidden_units + [1],bn, out_bias=out_bias)
...
def create_mlp(layer_sizes, bn ,out_bias=True):
    ls = list(layer_sizes)
